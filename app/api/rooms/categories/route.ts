...
/**
 * Proxy API requests to the backend server for room categories
 */
export async function GET() {
  try {
    // Construct the URL to the backend API
    const apiUrl = `${API_URL}/api/rooms/categories`;
    ...
    console.error("Error in categories API proxy:", error);
    return NextResponse.json(
