                  ...
                  {filteredBookings.map((booking) => (
                    <React.Fragment key={booking.id}>
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span
                            className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${getStatusBadgeClass(booking.status || "unknown")}`}
                          >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          >
                            ...
                            <span>
                              {selectedBooking === booking.id ? "Hide" : "View"}
                            </span>
                          </button>
                        </td>
                      </tr>
