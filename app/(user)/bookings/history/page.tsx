...
export default function BookingHistoryPage() {
      ...
      <main className="container mx-auto px-4 py-6 sm:py-8 max-w-6xl">
        ...
        <div className="bg-white p-6 rounded-lg shadow max-w-md mx-auto">
          ...
          <p className="text-gray-600 mb-4">
            Enter the email address you used to make your bookings.
          </p>
      ...
      <main className="container mx-auto px-4 py-6 sm:py-8 max-w-6xl">
        ...
        <div className="bg-white p-8 rounded-lg shadow-md text-center">
          ...
          <p className="text-gray-600 mb-6">
            You don&apos;t have any completed or cancelled bookings in your
            history yet.
          </p>
          <Link
            href="/dashboard"
            className="inline-block bg-[#1C3F32] text-white px-6 py-2 rounded-md hover:bg-[#1C3F32]/90 transition-colors"
          >
  ...
  return (
    <main className="container mx-auto px-4 py-6 sm:py-8 max-w-6xl">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                These bookings were cancelled and refunded
              </p>
            </div>
      ...
      {/* Room Statistics */}
      <h2 className="text-xl font-bold text-[#1C3F32] mb-4 border-b pb-2">
        Rooms You&apos;ve Booked
      </h2>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between">
                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 w-full sm:w-auto">
                  ...
                  <div className="text-center px-4 py-2 bg-gray-50 rounded-md">
                    ...
                    <p className="text-lg font-semibold text-[#1C3F32]">
            ...
            {expandedRoom === room.roomType && (
              <div className="border-t border-gray-200 p-4 bg-gray-50">
                <h4 className="text-base font-medium text-[#1C3F32] mb-3 flex items-center">
                  <FaCalendarAlt className="mr-2" /> Booking History for this
                  Room
                </h4>
                      ...
                      {room.bookings.map((booking) => (
                        <tr key={booking.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-4 py-3 whitespace-nowrap">
                            <span
                              className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${getStatusClass(booking.status)}`}
                            >
