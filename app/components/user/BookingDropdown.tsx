  ...
  return (
    ...
    >
      ...
      <div className="max-h-72 overflow-y-auto">
        {isLoading ? (
          ...
          <div className="p-4 text-center">
            ...
            <Link
              href="/dashboard"
              className="text-xs text-[#1C3F32] font-medium hover:underline"
            >
              Book a room now
            </Link>
          </div>
      ...
      <div className="p-2 bg-gray-50 flex justify-between items-center">
        <Link
          href="/bookings"
          className="text-sm text-[#1C3F32] font-medium hover:underline flex items-center"
        >
          View all bookings
        ...
        <Link
          ...
          className="text-sm text-[#1C3F32] font-medium hover:underline"
        >
          Booking history
        </Link>
      </div>
