...
export default function UserLayout({ children, hideNavbar = false, hideFooter = false }: UserLayoutProps) {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Main content */}
      <main className={`flex-grow ${!hideNavbar && !hideFooter ? 'container mx-auto px-4 py-8' : ''}`}>
        {children}
      </main>
